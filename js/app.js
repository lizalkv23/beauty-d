...
***************************************************************************** */
    ...
    function formWatch(event) {
        ...
        document.querySelector(".actions-header__btn");
        if (target.closest(".icon-menu")) {
            html.classList.add("menu-open");
            bodyLock();
        }
        if (target.closest(".actions-header__btn")) {
            html.classList.remove("menu-open");
            bodyUnlock();
        }
    }
    const scrollPage = document.querySelector(".preview");
    const pageImg = document.querySelector(".page-quote");
    let goToScrollValue;
    if (pageImg) goToScrollValue = pageImg.getBoundingClientRect().top - document.querySelector(".header").offsetHeight;
    ...
    if (scrollPage) scrollPage.addEventListener("click", (function(e) {
        if (e.target.closest(".preview__scroll") && pageImg) scrollTop();
    }));
    window["FLS"] = true;
    isWebp();
    spollers();
